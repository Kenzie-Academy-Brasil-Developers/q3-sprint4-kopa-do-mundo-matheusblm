...
create table if not exists estadios(
	...
	estadio VARCHAR(255),
	local VARCHAR(128),
	publico_pagamente integer 
);
insert into
estadios(edicao, ano, estadio, local, publico_pagamente)
values
...
select * from estadios where publico_pagamente > 100000;
select * from estadios where publico_pagamente > 50000 and publico_pagamente < 100000 ;
select * from estadios where right(estadio, 1) like 'y%';
